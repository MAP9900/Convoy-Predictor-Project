...
MODEL_SPECS = {
    ...
    "rf": {
        ...
        "grid_large": {
            ...
            "min_samples_leaf": [1, 2, 4, 8],
            "min_samples_split": [2, 5, 10],
            "max_features": ["sqrt", "log2", 0.4, 0.6, None],
            "class_weight": ["balanced", "balanced_subsample"],
        },
    ...
    "ada": {
        ...
        "grid_large": {
            ...
            "learning_rate": [0.02, 0.05, 0.1, 0.3, 0.6],
        },
    ...
    "lgbm": {
        ...
        "estimator": LGBMClassifier(
            n_estimators=2000, learning_rate=0.05, random_state=1945
        ...
        "grid_large": (lambda y=None: _with_spw({
            ...
            "feature_fraction": [0.6, 0.75, 0.9, 1.0],
            "bagging_fraction": [0.6, 0.75, 0.9, 1.0],
            "learning_rate": [0.02, 0.03, 0.05, 0.08],
            "n_estimators": [1000, 2000, 3000],
            "lambda_l2": [0.0, 1.0, 3.0, 5.0],
        }, y)),
        "config": {
            "scoring": "recall",
            "use_val_split": True,
